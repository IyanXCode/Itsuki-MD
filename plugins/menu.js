...
await conn.send3ButtonImg(m.chat, await (await fetch('https://telegra.ph/file/4afc10ce016e4a7689ed3.jpg')).buffer(),  '*Here my Command List *', text, 'Owner', '.owner', 'Information', '.info', 'Sewa', '.sewa', m)  
